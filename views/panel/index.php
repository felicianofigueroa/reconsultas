                ...
                <section id="view-dashboard" class="view-section active">
                    <div class="welcome-banner">
                        <div class="banner-text">
                            <h2>Bienvenido al Sistema de Recepción</h2>
                            <p>Gestione pacientes, agende citas con especialistas y controle los diagnósticos de manera
                                eficiente.</p>
                        </div>
                        <i class="fa-solid fa-notes-medical banner-icon"></i>
                    </div>
